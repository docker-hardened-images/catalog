...
This image runs the `prometheus-operator` binary. You can invoke it with various command-line flags to check the
...
```
$ docker run --rm <your-namespace>/dhi-prometheus-operator:<tag> -h
```
