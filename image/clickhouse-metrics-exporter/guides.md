...
This image runs the `clickhouse-metrics-exporter` binary. You can invoke it with various command-line flags to check the
...
```
$ docker run --rm <your-namespace>/clickhouse-metrics-exporter:<tag> -h
```
