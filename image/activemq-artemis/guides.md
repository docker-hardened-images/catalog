...
To start an ActiveMQ Artemis instance, run the following command. Replace `<your-namespace>` with your organization's
...
docker run -d \
  ...
  <your-namespace>/dhi-activemq-artemis:<tag>
```
