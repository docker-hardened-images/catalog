...
service connects to Hubble Relay to retrieve network flow data and queries the Kubernetes API to discover cluster
resources. It serves as the data layer for the Hubble UI frontend, providing real-time service map visualization and
network flow information.

### Start a Hubble UI Backend image
...
helm upgrade --install cilium cilium/cilium \
  ...
  --set hubble.ui.backend.image.override="<IMAGE_REPOSITORY>:<IMAGE_TAG>" \
...
| Feature         | Non-hardened Hubble UI Backend | Docker Hardened Hubble UI Backend                   |
| --------------- | ------------------------------ | --------------------------------------------------- |
...
Switching to the hardened Hubble UI Backend image does not require any special changes. You can use it as a drop-in
replacement for the standard Hubble UI Backend (`cilium/hubble-ui-backend`) image in your existing workflows and
