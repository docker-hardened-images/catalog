...
The following example assumes you have a `logstash.conf` file in the current directory. Using a bind mount or volume,
you can run Logstash with a custom pipeline.
...
To override settings like `pipeline.workers`, you can pass them as environment variables:
