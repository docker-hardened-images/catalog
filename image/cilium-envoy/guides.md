...
### Start a cilium-envoy container

**Note:** cilium-envoy is designed to run within a Kubernetes cluster as proxy layer for Cilium components. The
following standalone Docker command displays the available configuration options.

```bash
docker run --rm -it dhi.io/cilium-envoy:<tag> --help
```
