...
This image contains `neo4j`, which can be run as a deployment using `docker run` or in cluster deployment on Kubernetes.
...
| Feature         | Non-hardened Neo4j                  | Docker Hardened Neo4j                               |
| --------------- | ----------------------------------- | --------------------------------------------------- |
