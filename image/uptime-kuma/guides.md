...
By default, the `/app/data` directory inside the container will be used. To customize, specify a volume or directory on
the host to mount to the `/app/data` directory inside the container, where Uptime Kuma will store its monitors, uptime
