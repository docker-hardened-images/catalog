...
`ML_PIPELINE_SERVICE_HOST` and `ML_PIPELINE_SERVICE_PORT` environment variables.

## Common Kubeflow Pipelines Frontend use cases

### Connect to a Kubeflow Pipelines API server

To connect the frontend to your Kubeflow Pipelines API server, specify the server host and port using environment
variables:
...
Create a docker-compose.yml file to run the frontend alongside other Kubeflow components:
...
| Feature         | Docker Official Kubeflow Pipelines Frontend | Docker Hardened Kubeflow Pipelines Frontend         |
| --------------- | ------------------------------------------- | --------------------------------------------------- |
