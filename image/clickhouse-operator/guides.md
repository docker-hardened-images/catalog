...
This image runs the `clickhouse-operator` binary. You can invoke it with various command-line flags to check the
...
```
$ docker run --rm <your-namespace>/dhi-clickhouse-operator:<tag> -h
```
