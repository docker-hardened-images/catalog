...
The Docker Scout CLI requires authentication with Docker Hub credentials. To pass credentials into the container, you
can use:
...
To analyze a container image for CVEs (Common Vulnerabilities and Exposures):
...
To compare two images and see the difference in vulnerabilities:
...
To get recommendations for base image updates:
...
To generate and view the Software Bill of Materials (SBOM) for an image:
...
To evaluate an image against Docker Scout policies:
...
If you need to analyze images from private registries, you can mount your Docker config:
