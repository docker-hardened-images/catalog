...
authentication service that enables users to authenticate to Kubernetes clusters using external identity providers. The
CLI tool helps users authenticate and generate kubeconfig credentials for accessing Kubernetes clusters secured with
Pinniped.

### Start a Pinniped CLI instance

The Pinniped CLI is typically used to authenticate to Kubernetes clusters. To display the help information and available
commands, run:
...
| Feature         | Non-hardened Pinniped CLI           | Docker Hardened Pinniped CLI                        |
| --------------- | ----------------------------------- | --------------------------------------------------- |
...
Switching to the hardened Pinniped CLI image does not require any special changes. You can use it as a drop-in
replacement for the standard Pinniped CLI image in your existing workflows, Dockerfiles, and scripts. Note that the
