...
The Scout SBOM Indexer is indeeded to be used with `docker buildx build` using the following command:
...
The package catalogers that are used can be configured using the following command line:
