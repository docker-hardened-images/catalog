...
```bash
docker run -d --name victoriametrics-vminsert -p 8480:8480 <your-namespace>/dhi-victoriametrics-vminsert:<tag>
```
...
docker run --rm -it --pid container:my-container \
  ...
  <your-namespace>/dhi-victoriametrics-vminsert:<tag> /dbg/bin/sh
```
...
1. Update your image reference.
   ...
   - From: `victoriametrics/vminsert:<tag>`
   - To: `<your-namespace>/dhi-victoriametrics-vminsert:<tag>`
