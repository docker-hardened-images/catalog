...
The static image is a minimal runtime-only image designed specifically for running statically-linked binary executables.
All variants of this image:

- Run as the nonroot user
- Contain ca-certificates and tzdata (library variants also include musl or libc6)
- Are intended for use as the final stage in multi-stage builds

### Available variants

- Alpine-based: Minimal image with ca-certificates and tzdata. Use this for statically-linked binaries.
- Alpine with musl: Includes the musl C library in addition to ca-certificates and tzdata. Use this variant if your
  binary requires musl for dynamic linking.
- Debian-based: Minimal image with ca-certificates and tzdata. Use this for statically-linked binaries.
