       ...
       images:
         proxy:
          registry: registry-1.docker.io
           image: <your-namespace>/dhi-traefik
   image:
    registry: registry-1.docker.io
     repository: <your-namespace>/dhi-traefik
  ```
...
- Pre-rendering:
  ...
  ```console
  helm install my-traefik oci://registry-1.docker.io/<your-namespace>/dhi-traefik-chart --version <version> \
...
my-traefik-traefik-chart-85bb5c464c-8fnjt   1/1     Running   0          20s
```

Now after enabling a port forward rule to port 80:

```console
$ kubectl port-forward service/my-traefik-traefik-chart 8080:80
Forwarding from 127.0.0.1:8080 -> 8000
Forwarding from [::1]:8080 -> 8000
```

The dashboard should be visible on http://localhost:8080/dashboard
