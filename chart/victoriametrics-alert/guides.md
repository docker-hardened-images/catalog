...
own registry. To allow your Kubernetes alert to pull those images, you need to create a Kubernetes secret with your
...
- To use pre-rendering:
  ...
  global:
    vmalert:
      image:
        repository: "docker.io/<your-namespace>/dhi-victoriametrics-vmalert"
  ```
...
- Pre-rendering:
  ...
  ```console
  helm install mvc oci://registry-1.docker.io/<your-namespace>/dhi-victoriametrics-alert --version <version> \
...
pod/dhi-victoriametrics-alert-victoriametrics-alert-chart-servh5vc7   0/1     Running        0          3s

NAME                                                                   TYPE        CLUSTER-IP   EXTERNAL-IP   PORT(S)    AGE
service/dhi-victoriametrics-alert-victoriametrics-alert-chart-server   ClusterIP   10.96.0.1    <none>        8880/TCP   3s
service/kubernetes                                                     ClusterIP   10.96.0.1    <none>        443/TCP    52m

NAME                                                                           READY   UP-TO-DATE   AVAILABLE   AGE
deployment.apps/dhi-victoriametrics-alert-victoriametrics-alert-chart-server   0/1     1            0           3s

NAME                                                                                      DESIRED   CURRENT   READY   AGE
replicaset.apps/dhi-victoriametrics-alert-victoriametrics-alert-chart-server-7455f9cbd6   1         1         0       3s
```
