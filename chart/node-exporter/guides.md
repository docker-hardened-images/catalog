...
- To use pre-rendering:
  ...
  image:
    ...
    repository: <your-namespace>/dhi-node-exporter
  kubeRBACProxy:
    image:
    registry: registry-1.docker.io
    repository: <your-namespace>/dhi-kube-rbac-proxy
  ```
...
- Pre-rendering:
  ...
  ```console
  helm install my-node-exporter oci://registry-1.docker.io/<your-namespace>/dhi-node-exporter-chart --version <version> \
...
- Post-rendering:
  ...
  ```console
  helm install my-kube-sate-metrics oci://registry-1.docker.io/<your-namespace>/dhi-node-exporter-chart --version <version> \
    --set "imagePullSecrets[0]=helm-pull-secret" \
...
pod/my-prometheus-node-exporter-chart-n5n86     1/1     Running   0          56s

NAME                                          TYPE        CLUSTER-IP    EXTERNAL-IP   PORT(S)    AGE
service/kubernetes                            ClusterIP   10.43.0.1     <none>        443/TCP    66s
service/my-prometheus-node-exporter-chart     ClusterIP   10.43.8.235   <none>        9100/TCP   56s

NAME                                                 DESIRED   CURRENT   READY   UP-TO-DATE   AVAILABLE   NODE SELECTOR            AGE
daemonset.apps/my-prometheus-node-exporter-chart     1         1         1       1            1           kubernetes.io/os=linux   56s
```
