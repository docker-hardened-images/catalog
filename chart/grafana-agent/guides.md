...
- To use pre-rendering:
  ...
  ```yaml
  image:
    repository: <your-namespace>/dhi-grafana-agent
  configReloader:
    image:
...
- Pre-rendering:
  ...
  ```console
  helm install my-grafana-agent oci://registry-1.docker.io/<your-namespace>/dhi-grafana-agent-chart --version <version> \
...
pod/my-grafana-agent-chart-rk7g7     2/2     Running   0          116s

NAME                               TYPE        CLUSTER-IP      EXTERNAL-IP   PORT(S)   AGE
service/kubernetes                 ClusterIP   10.43.0.1       <none>        443/TCP   2m22s
service/my-grafana-agent-chart     ClusterIP   10.43.213.197   <none>        80/TCP    116s

NAME                                      DESIRED   CURRENT   READY   UP-TO-DATE   AVAILABLE   NODE SELECTOR   AGE
daemonset.apps/my-grafana-agent-chart     1         1         1       1            1           <none>          116s
```
