...
- To use pre-rendering:
  ...
  ```yaml
   image:
     repository: <your-namespace>/dhi-vector
   haproxy:
     image:
...
- Pre-rendering:
  ...
  ```console
  helm install my-vector oci://registry-1.docker.io/<your-namespace>/dhi-vector-chart --version <version> \
...
Vector's main pod should show up and running almost immediately:

```console
$ kubectl get pods
NAME                                   READY   STATUS    RESTARTS   AGE
my-vector-vector-chart-0               1/1     Running   0          17s
```
