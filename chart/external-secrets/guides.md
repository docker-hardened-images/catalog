...
- To use pre-rendering:
  ...
  ```yaml
  image:
    repository: <your-namespace>/dhi-external-secrets
  webhook:
    repository: <your-namespace>/dhi-external-secrets
  certController:
    repository: <your-namespace>/dhi-external-secrets
...
- Pre-rendering:
  ...
  ```console
  helm install my-external-secrets oci://registry-1.docker.io/<your-namespace>/dhi-external-secrets-chart --version <version> \
