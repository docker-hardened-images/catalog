...
- To use pre-rendering:
  ...
  ```yaml
  image:
    repository: <your-namespace>/dhi-alloy
  configReloader:
    image:
      repository: <your-namespace>/prometheus-config-reloader
  ```
...
- Pre-rendering:
  ...
  ```console
  helm install my-alloy oci://registry-1.docker.io/<your-namespace>/dhi-alloy-chart --version <version> \
...
pod/my-alloy-chart-rk7g7             2/2     Running   0          116s

NAME                               TYPE        CLUSTER-IP      EXTERNAL-IP   PORT(S)   AGE
service/kubernetes                 ClusterIP   10.43.0.1       <none>        443/TCP   2m22s
service/my-alloy-chart             ClusterIP   10.43.213.197   <none>        80/TCP    116s

NAME                                      DESIRED   CURRENT   READY   UP-TO-DATE   AVAILABLE   NODE SELECTOR   AGE
daemonset.apps/my-alloy-chart             1         1         1       1            1           <none>          116s
```
