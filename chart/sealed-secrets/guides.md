...
- To use pre-rendering:
  ...
  ```yaml
   image:
     ...
     repository: <your-namespace>/dhi-sealed-secrets-controller
  ```

  Replace `registry-1docker.io` with your own registry if you are using one. Replace `<your-namespace>` with your Docker
  Hub namespace or with your own namespace in your own registry.
...
- Pre-rendering:
  ...
  ```console
  helm install my-sealed-secrets oci://registry-1.docker.io/<your-namespace>/dhi-sealed-secrets-chart --version <version> \
...
Sealed Secrets Controller should be up and running.

```console
kubectl get all
NAME                                                          READY   STATUS    RESTARTS   AGE
pod/my-sealed-secrets-sealed-secrets-chart-54c5fc9db8-crvx2   1/1     Running   0          32s

NAME                                                     TYPE        CLUSTER-IP     EXTERNAL-IP   PORT(S)    AGE
service/kubernetes                                       ClusterIP   10.96.0.1      <none>        443/TCP    59d
service/my-sealed-secrets-sealed-secrets-chart           ClusterIP   10.106.65.30   <none>        8080/TCP   32s
service/my-sealed-secrets-sealed-secrets-chart-metrics   ClusterIP   10.106.99.65   <none>        8081/TCP   32s

NAME                                                     READY   UP-TO-DATE   AVAILABLE   AGE
deployment.apps/my-sealed-secrets-sealed-secrets-chart   1/1     1            1           32s

NAME                                                                DESIRED   CURRENT   READY   AGE
replicaset.apps/my-sealed-secrets-sealed-secrets-chart-54c5fc9db8   1         1         1       32s
```
