...
- To use pre-rendering:
  ...
  ```yaml
   ...
   image: <your-namespace>/dhi-ztunnel
  ```
...
- Pre-rendering:
  ...
  ```console
  helm install my-ztunnel oci://registry-1.docker.io/<your-namespace>/dhi-ztunnel-chart --version <version> \
...
The ztunnel DaemonSet pods should show up and running on all nodes:

```bash
$ kubectl get pods
NAME            READY   STATUS    RESTARTS   AGE
ztunnel-xxxxx   1/1     Running   0          30s
ztunnel-yyyyy   1/1     Running   0          30s
```

You can verify the ztunnel deployment with:

```bash
$ kubectl get daemonset
NAME      DESIRED   CURRENT   READY   UP-TO-DATE   AVAILABLE   NODE SELECTOR   AGE
ztunnel   2         2         2       2            2           <none>          30s
```
