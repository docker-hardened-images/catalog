...
- To use pre-rendering:
  ...
  ```yaml
  image:
    repository: <your-namespace>/dhi-external-dns
  ```
...
- Pre-rendering:
  ...
  ```console
  helm install my-external-dns oci://registry-1.docker.io/<your-namespace>/dhi-external-dns-chart --version <version> \
...
my-external-dns-external-dns-chart-5bfdf5596d-nc2xm   1/1     Running   0          20s
```
