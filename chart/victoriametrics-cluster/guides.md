...
- To use pre-rendering:
  ...
  global:
    vmstorage:
      image:
        repository: "docker.io/<your-namespace>/dhi-victoriametrics-vmstorage"
    vminsert:
      image:
        repository: "docker.io/<your-namespace>/dhi-victoriametrics-vminsert"
    vmselect:
      image:
        repository: "docker.io/<your-namespace>/dhi-victoriametrics-vmselect"
  ```
...
- Pre-rendering:
  ...
  ```console
  helm install mvc oci://registry-1.docker.io/<your-namespace>/dhi-victoriametrics-cluster --version <version> \
...
VictoriaMetrics' pods should show up and running almost immediately:

```console
$ kubectl get all
NAME                                                              READY   STATUS    RESTARTS   AGE
pod/mvc-victoriametrics-cluster-chart-vminsert-6fb89567bd-4s5bx   1/1     Running   0          2m5s
pod/mvc-victoriametrics-cluster-chart-vminsert-6fb89567bd-q52db   1/1     Running   0          2m5s
pod/mvc-victoriametrics-cluster-chart-vmselect-98dc8d588-kw94m    1/1     Running   0          2m5s
pod/mvc-victoriametrics-cluster-chart-vmselect-98dc8d588-tmmjs    1/1     Running   0          2m5s
pod/mvc-victoriametrics-cluster-chart-vmstorage-0                 1/1     Running   0          2m5s
pod/mvc-victoriametrics-cluster-chart-vmstorage-1                 1/1     Running   0          100s

NAME                                                  TYPE        CLUSTER-IP      EXTERNAL-IP   PORT(S)                      AGE
service/kubernetes                                    ClusterIP   10.96.0.1       <none>        443/TCP                      62d
service/mvc-victoriametrics-cluster-chart-vminsert    ClusterIP   10.111.47.60    <none>        8480/TCP                     2m5s
service/mvc-victoriametrics-cluster-chart-vmselect    ClusterIP   10.105.190.43   <none>        8481/TCP                     2m5s
service/mvc-victoriametrics-cluster-chart-vmstorage   ClusterIP   None            <none>        8482/TCP,8401/TCP,8400/TCP   2m5s

NAME                                                         READY   UP-TO-DATE   AVAILABLE   AGE
deployment.apps/mvc-victoriametrics-cluster-chart-vminsert   2/2     2            2           2m5s
deployment.apps/mvc-victoriametrics-cluster-chart-vmselect   2/2     2            2           2m5s

NAME                                                                    DESIRED   CURRENT   READY   AGE
replicaset.apps/mvc-victoriametrics-cluster-chart-vminsert-6fb89567bd   2         2         2       2m5s
replicaset.apps/mvc-victoriametrics-cluster-chart-vmselect-98dc8d588    2         2         2       2m5s

NAME                                                           READY   AGE
statefulset.apps/mvc-victoriametrics-cluster-chart-vmstorage   2/2     2m5s
```
