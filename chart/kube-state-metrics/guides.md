...
- To use pre-rendering:
  ...
  image:
    ...
    repository: <your-namespace>/dhi-kube-state-metrics
  kubeRBACProxy:
    image:
    registry: registry-1.docker.io
...
- Pre-rendering:
  ...
  ```console
  helm install my-kube-state-metrics oci://registry-1.docker.io/<your-namespace>/dhi-kube-state-metrics-chart --version <version> \
...
- Post-rendering:
  ...
  ```console
  helm install my-kube-sate-metrics oci://registry-1.docker.io/<your-namespace>/dhi-kube-state-metrics-chart --version <version> \
    --set "imagePullSecrets[0]=helm-pull-secret" \
