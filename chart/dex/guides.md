...
- To use pre-rendering:
  ...
  ```yaml
  image:
    repository: <your-namespace>/dhi-dex
  ```
...
Create the minimal configuration that Dex needs to run:

```console
$ cat > values-override.yaml << 'EOF'
config:
  # Set it to a valid URL
  issuer: http://dex.internal
...
- Pre-rendering:
  ...
  ```console
  helm install my-dex oci://registry-1.docker.io/<your-namespace>/dhi-dex-chart --version <version> \
...
pod/my-dex-dex-chart-5c4fc84bbf-kx9cd   1/1     Running   0          18s

NAME                       TYPE        CLUSTER-IP     EXTERNAL-IP   PORT(S)             AGE
service/my-dex-dex-chart   ClusterIP   10.96.48.167   <none>        5556/TCP,5558/TCP   18s

NAME                               READY   UP-TO-DATE   AVAILABLE   AGE
deployment.apps/my-dex-dex-chart   1/1     1            1           18s
```
